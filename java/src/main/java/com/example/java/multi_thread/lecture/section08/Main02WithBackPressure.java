...
/**
 * 쓰기 작업이 읽기작업 보다 오래걸리기 때문에
 * Back Pressure 적용
 * */
public class Main02WithBackPressure {
    ...
    private static class MatricesMultiplierConsumer extends Thread {
        ...
        private MatricesMultiplierConsumer(FileWriter fileWriter, ThreadSafeQueue queue) {
    ...
    private static class ThreadSafeQueue {
        ...
        public synchronized MatricesPair remove() {
            ...
            /**************제거한 이후 한계용량보다 하나가 줄 었다면 add 스레스 깨움**************/
